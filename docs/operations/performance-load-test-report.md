...
## 4. 핵심 실험 1 — 최초 병목은 RDS가 아니라 Backend CPU
...
## 5. 핵심 실험 2 — 사이징 조정 후 p95 60초 → 96ms
...
## 6. 핵심 실험 3 — SQS 100,000건 backlog와 Worker Auto Scaling
...
## 7. 핵심 실험 4 — 3,000~10,000 VU에서 rate limit과 인프라 한계 분리
...
## 8. 핵심 실험 5 — 10,000 VU large-A 개선 실험
