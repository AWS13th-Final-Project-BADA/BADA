  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        { name = "GF_SECURITY_ADMIN_PASSWORD", value = "bada-admin-2026" },
        { name = "GF_SERVER_ROOT_URL", value = "https://monitor.badasoft.com" },
      ]
      logConfiguration = {
        logDriver = "awslogs"
        options = {
...
resource "aws_ecs_service" "prometheus" {
  ...
  desired_count   = var.monitoring_enabled ? 1 : 0
  launch_type     = "FARGATE"
